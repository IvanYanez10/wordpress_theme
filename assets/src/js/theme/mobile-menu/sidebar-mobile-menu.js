    ...
    sidr.new(".mobile-menu", {
      ...
      onOpen() {
        ...
        self.#elements.header.insertAdjacentHTML(
          "afterend",
          '<div class="subetuwebwp-sidr-overlay" tabindex=0></div>'
        );

        const overlay = document.querySelector(".subetuwebwp-sidr-overlay");
...
subetuwebwp.sidebarMobileMenu = new SidebarMobileMenu();
