class OWLightbox {
  ...
  initSingleImageLightbox = () => {
    document.querySelectorAll(".subetuwebwp-lightbox")?.forEach((link) => {
    ...
    jQuery(".subetuwebwp-lightbox").magnificPopup({
      type: "image",
      ...
      ?.forEach((link) => {
        if (!!link.querySelector("img")) {
          ...
          if (
            ...
            link.classList.add("subetuwebwp-lightbox");
          }
...
subetuwebwp.owLightbox = new OWLightbox();
