...
class WooGridList {
  ...
  #setElements = () => {
    this.#elements = {
      ...this.#elements,
      grid: document.querySelector(".subetuwebwp-grid-list #subetuwebwp-grid"),
      list: document.querySelector(".subetuwebwp-grid-list #subetuwebwp-list"),
  ...
  #productCarousel = () => {
    if (
      ...
      subetuwebwp.owSlider.flickity?.forEach((flickity) => {
        flickity.destroy();
      });
    }
