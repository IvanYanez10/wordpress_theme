...
if ( ! function_exists( 'subetuwebwp_theme_icons' ) ) {
	 ...
	 * @since 2.0
	 */
	function subetuwebwp_theme_icons() {

		$subetuwebwp_theme_icons = array(
			'home'                   => array(
				'sili' => 'icon-home',
				'fai'  => 'fas fa-home',
				'svg'  => 'homepage',
		...
		return apply_filters( 'subetuwebwp_theme_icons', $subetuwebwp_theme_icons );
	}
}
 ...
 * @since 2.0
 */
if ( ! function_exists( 'subetuwebwp_theme_icon_class' ) ) {

	function subetuwebwp_theme_icon_class() {

		$i_class = get_theme_mod( 'subetuweb_theme_default_icons', 'sili' );
		...
		if ( 'sili' === $i_class ) {
			...
			return __( 'Please select an icon type.', 'subetuwebwp' );
		}

		return apply_filters( 'subetuwebwp_theme_icon_class', $ti_class );
	}
}
 ...
 * @since 2.0
 */
if ( ! function_exists( 'subetuwebwp_theme_blog_meta_separator' ) ) {

	function subetuwebwp_theme_blog_meta_separator() {

		$meta_style = get_theme_mod( 'subetuweb_blog_meta_separator', 'default' );

		$meta_style = $meta_style ? $meta_style : 'default';

		return apply_filters( 'subetuwebwp_theme_blog_meta_separator', $meta_style );
	}
}
...
if ( ! function_exists( 'subetuwebwp_theme_single_post_separator' ) ) {
	...
	function subetuwebwp_theme_single_post_separator() {
		...
		return apply_filters( 'subetuwebwp_theme_single_post_separator', $sep_style );
	}
}

function get_subetuweb_icon( $args = array() ) {

	// Make sure $args are an array.
	if ( empty( $args ) ) {
		return __( 'Please define default parameters in the form of an array.', 'subetuwebwp' );
	}
	...
	// Get icon class.
	$theme_icons = subetuwebwp_theme_icons();
	$icon_class  = subetuwebwp_theme_icon_class();
 ...
 * Display the icons
 */
if ( ! function_exists( 'subetuwebwp_print_icon' ) ) {

	function subetuwebwp_print_icon( $args = array(), $echo = true ) {
		if ( empty( $args ) ) {
			return __( 'Please define default parameters in the form of an array.', 'subetuwebwp' );
		}

		$icon      = '';
		$icon_type = get_theme_mod( 'subetuweb_theme_default_icons', 'sili' );

		if ( isset( $icon_type ) && ! empty( $icon_type ) ) {

			if ( 'sili' === $icon_type || 'fai' === $icon_type ) {
				$icon = get_subetuweb_icon( $args );
			} elseif ( 'svg' === $icon_type ) {
				$icon = subetuweb_svg_print_icon( $args, false );
			} else {
				return __( 'Please define an icon type.', 'subetuwebwp' );
			}
		}

		$icon = apply_filters( "subetuwebwp_print_icon_{$icon}", $icon );
 ...
 *
 * @return string subetuwebWP Icon.
 */
if ( ! function_exists( 'subetuwebwp_icon' ) ) {

	function subetuwebwp_icon( $icon, $echo = true, $class = '', $title = '', $desc = '', $aria_hidden = true, $fallback = false ) {

		$icon = subetuwebwp_print_icon(
			array(
				'icon'        => $icon,
				'class'       => $class,
				'title'       => $title,
		...
		$icon = apply_filters( "subetuwebwp_icon_{$icon}", $icon );
