...
if ( ! class_exists( 'subetuwebWP_Elementor' ) ) :

	class subetuwebWP_Elementor {
		...
		public static function get_topbar_content_id() {
			...
			// Template
			$id = get_theme_mod( 'subetuweb_top_bar_template' );
		...
		public static function get_topbar_social_alt_id() {
			...
			// Template
			$id = get_theme_mod( 'subetuweb_top_bar_social_alt_template' );
		...
		public static function get_vertical_header_id() {
			...
			// Template
			$id = get_theme_mod( 'subetuweb_vertical_header_template' );
		...
		public static function get_vertical_header_bottom_id() {
			...
			// Template
			$id = get_theme_mod( 'subetuweb_vertical_header_bottom_template' );
		...
		public static function get_header_id() {
			...
			// Template
			$id = subetuwebwp_custom_header_template();
		...
		public static function get_nav_id() {
			...
			// Template
			$id = subetuwebwp_custom_nav_template();
		...
		public static function get_social_menu_id() {
			...
			// Template
			$id = get_theme_mod( 'subetuweb_menu_social_template' );
		...
		public static function get_footer_id() {
			...
			// Template
			$id = subetuwebwp_custom_footer_template();
		...
		public static function get_error_page_id() {
			...
			// Template
			$id = get_theme_mod( 'subetuweb_error_page_template' );
		...
		public static function preview_styles() {
			wp_enqueue_style( 'subetuwebwp-elementor-preview', subetuwebWP_CSS_DIR_URI .'third/elementor-editor.min.css' );
		}
...
return new subetuwebWP_Elementor();