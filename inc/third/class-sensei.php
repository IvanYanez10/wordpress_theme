...
if ( ! class_exists( 'subetuwebWP_Sensei' ) ) :

	class subetuwebWP_Sensei {
		...
		public static function add_custom_css() {
			if ( is_sensei() || is_tax( 'module' ) ) {
				wp_enqueue_style( 'subetuwebwp-sensei', subetuwebWP_CSS_DIR_URI .'third/sensei.min.css' );
			}
		}
		...
		public static function wrapper_start() {
			...
			<div id="content-wrap" class="container subetuwebwp-sensei clr">
