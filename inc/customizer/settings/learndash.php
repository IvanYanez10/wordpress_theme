...
if ( ! class_exists( 'subetuwebWP_LearnDash_Customizer' ) ) :

	/**
	 * Settings for general options
	 */
	class subetuwebWP_LearnDash_Customizer {
		...
		public function customizer_options( $wp_customize ) {
			 ...
			 * Panel
			 */
			$panel = 'subetuweb_ld_panel';
			$wp_customize->add_panel(
				$panel,
				array(
					'title'    => esc_html__( 'LearnDash', 'subetuwebwp' ),
					'priority' => 210,
				)
			);
			 ...
			 */
			$wp_customize->add_setting(
				'subetuweb_ld_distraction_free_learning',
				array(
					'default'           => false,
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'     => 'checkbox',
						'section'  => 'subetuweb_ld_general',
						'settings' => 'subetuweb_ld_distraction_free_learning',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new subetuwebWP_Customizer_Radio_Image_Control(
					...
					array(
						...
						'section'  => 'subetuweb_ld_layout',
						'settings' => 'subetuweb_ld_global_layout',
						'priority' => 10,
			 ...
			 */
			$wp_customize->add_setting(
				'subetuweb_ld_global_both_sidebars_style',
				array(
					'default'           => 'scs-style',
					'sanitize_callback' => 'subetuwebwp_sanitize_select',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'select',
						'section'         => 'subetuweb_ld_layout',
						'settings'        => 'subetuweb_ld_global_both_sidebars_style',
						'priority'        => 10,
						'choices'         => array(
						...
						'active_callback' => 'subetuwebwp_cac_has_ld_global_bs_layout',
					)
				)
			);
			 ...
			 */
			$wp_customize->add_setting(
				'subetuweb_ld_global_both_sidebars_content_width',
				array(
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'number',
						'section'         => 'subetuweb_ld_layout',
						'settings'        => 'subetuweb_ld_global_both_sidebars_content_width',
						'priority'        => 10,
						'input_attrs'     => array(
							'min'  => 0,
							'max'  => 100,
			 ...
			 */
			$wp_customize->add_setting(
				'subetuweb_ld_global_both_sidebars_sidebars_width',
				array(
					'transport'         => 'postMessage',
					'sanitize_callback' => 'subetuwebwp_sanitize_number_blank',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'number',
						'section'         => 'subetuweb_ld_layout',
						'settings'        => 'subetuweb_ld_global_both_sidebars_sidebars_width',
						'priority'        => 10,
						'input_attrs'     => array(
							'min'  => 0,
							'max'  => 100,
			 ...
			 */
			$wp_customize->add_setting(
				'subetuweb_ld_global_sidebar_order',
				array(
			...
			$wp_customize->add_control(
				new subetuwebWP_Customizer_Radio_Image_Control(
					...
					array(
						'label'    => esc_html__( 'Layout', 'subetuwebwp' ),
						'section'  => 'subetuweb_ld_layout',
						'settings' => 'subetuweb_ld_course_layout',
						'priority' => 10,
						'choices'  => subetuwebwp_customizer_layout(),
					)
				)
			 ...
			 */
			$wp_customize->add_setting(
				'subetuweb_ld_course_both_sidebars_style',
				array(
					'default'           => 'scs-style',
					'sanitize_callback' => 'subetuwebwp_sanitize_select',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'select',
						'section'         => 'subetuweb_ld_layout',
						'settings'        => 'subetuweb_ld_course_both_sidebars_style',
						'priority'        => 10,
						'choices'         => array(
							'ssc-style' => esc_html__( 'Sidebar / Sidebar / Content', 'subetuwebwp' ),
							'scs-style' => esc_html__( 'Sidebar / Content / Sidebar', 'subetuwebwp' ),
						...
						'active_callback' => 'subetuwebwp_cac_has_ld_course_bs_layout',
					)
				)
			);
			 ...
			 */
			$wp_customize->add_setting(
				'subetuweb_ld_course_both_sidebars_content_width',
				array(
					'transport'         => 'postMessage',
					'sanitize_callback' => 'subetuwebwp_sanitize_number_blank',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'number',
						'section'         => 'subetuweb_ld_layout',
						'settings'        => 'subetuweb_ld_course_both_sidebars_content_width',
						'priority'        => 10,
						'input_attrs'     => array(
							'min'  => 0,
							'max'  => 100,
			 ...
			 */
			$wp_customize->add_setting(
				'subetuweb_ld_course_both_sidebars_sidebars_width',
				array(
					'transport'         => 'postMessage',
					'sanitize_callback' => 'subetuwebwp_sanitize_number_blank',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'number',
						'section'         => 'subetuweb_ld_layout',
						'settings'        => 'subetuweb_ld_course_both_sidebars_sidebars_width',
						'priority'        => 10,
						'input_attrs'     => array(
							'min'  => 0,
							'max'  => 100,
			 ...
			 */
			$wp_customize->add_setting(
				'subetuweb_ld_course_sidebar_order',
				array(
					'default'           => 'content-sidebar',
					'sanitize_callback' => 'subetuwebwp_sanitize_select',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'select',
						'section'         => 'subetuweb_ld_layout',
						'settings'        => 'subetuweb_ld_course_sidebar_order',
						'priority'        => 10,
						'choices'         => array(
							'content-sidebar' => esc_html__( 'Content / Sidebar', 'subetuwebwp' ),
							'sidebar-content' => esc_html__( 'Sidebar / Content', 'subetuwebwp' ),
						),
						'active_callback' => 'subetuwebwp_cac_has_ld_course_rl_layout',
					)
				)
			);
			...
			$wp_customize->add_control(
				new subetuwebWP_Customizer_Heading_Control(
					...
					'subetuweb_ld_lesson_heading',
					array(
						'label'    => esc_html__( 'Lesson/Topic', 'subetuwebwp' ),
						'section'  => 'subetuweb_ld_layout',
						'priority' => 10,
					)
				)
			...
			$wp_customize->add_control(
				new subetuwebWP_Customizer_Radio_Image_Control(
					...
					array(
						'label'    => esc_html__( 'Layout', 'subetuwebwp' ),
						'section'  => 'subetuweb_ld_layout',
						'settings' => 'subetuweb_ld_lesson_layout',
						'priority' => 10,
						'choices'  => subetuwebwp_customizer_layout(),
					)
				)
			 ...
			 */
			$wp_customize->add_setting(
				'subetuweb_ld_lesson_both_sidebars_style',
				array(
					'default'           => 'scs-style',
					'sanitize_callback' => 'subetuwebwp_sanitize_select',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'select',
						'section'         => 'subetuweb_ld_layout',
						'settings'        => 'subetuweb_ld_lesson_both_sidebars_style',
						'priority'        => 10,
						'choices'         => array(
							'ssc-style' => esc_html__( 'Sidebar / Sidebar / Content', 'subetuwebwp' ),
							'scs-style' => esc_html__( 'Sidebar / Content / Sidebar', 'subetuwebwp' ),
						...
						'active_callback' => 'subetuwebwp_cac_has_ld_lesson_bs_layout',
					)
				)
			);
			 ...
			 */
			$wp_customize->add_setting(
				'subetuweb_ld_lesson_both_sidebars_content_width',
				array(
					'transport'         => 'postMessage',
					'sanitize_callback' => 'subetuwebwp_sanitize_number_blank',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'number',
						'section'         => 'subetuweb_ld_layout',
						'settings'        => 'subetuweb_ld_lesson_both_sidebars_content_width',
						'priority'        => 10,
						'input_attrs'     => array(
							'min'  => 0,
							'max'  => 100,
			 ...
			 */
			$wp_customize->add_setting(
				'subetuweb_ld_lesson_both_sidebars_sidebars_width',
				array(
					'transport'         => 'postMessage',
					'sanitize_callback' => 'subetuwebwp_sanitize_number_blank',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'number',
						'section'         => 'subetuweb_ld_layout',
						'settings'        => 'subetuweb_ld_lesson_both_sidebars_sidebars_width',
						'priority'        => 10,
						'input_attrs'     => array(
							'min'  => 0,
							'max'  => 100,
			 ...
			 */
			$wp_customize->add_setting(
				'subetuweb_ld_lesson_sidebar_order',
				array(
					'default'           => 'content-sidebar',
					'sanitize_callback' => 'subetuwebwp_sanitize_select',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'select',
						'section'         => 'subetuweb_ld_layout',
						'settings'        => 'subetuweb_ld_lesson_sidebar_order',
						'priority'        => 10,
						'choices'         => array(
							'content-sidebar' => esc_html__( 'Content / Sidebar', 'subetuwebwp' ),
							'sidebar-content' => esc_html__( 'Sidebar / Content', 'subetuwebwp' ),
						),
						'active_callback' => 'subetuwebwp_cac_has_ld_lesson_rl_layout',
					)
				)
			);
			...
			$wp_customize->add_control(
				new subetuwebWP_Customizer_Heading_Control(
					...
					'subetuweb_lld_styling_course',
					array(
						'label'    => esc_html__( 'Table', 'subetuwebwp' ),
						'section'  => 'subetuweb_ld_styling',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new subetuwebWP_Customizer_Color_Control(
					...
					'subetuweb_ld_heading_color',
					array(
						'label'    => esc_html__( 'Heading Color', 'subetuwebwp' ),
						'section'  => 'subetuweb_ld_styling',
						'settings' => 'subetuweb_ld_heading_color',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new subetuwebWP_Customizer_Color_Control(
					...
					'subetuweb_ld_heading_bg_color',
					array(
						'label'    => esc_html__( 'Heading Background Color', 'subetuwebwp' ),
						'section'  => 'subetuweb_ld_styling',
						'settings' => 'subetuweb_ld_heading_bg_color',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new subetuwebWP_Customizer_Color_Control(
					...
					'subetuweb_ld_item_color',
					array(
						'label'    => esc_html__( 'Item Color', 'subetuwebwp' ),
						'section'  => 'subetuweb_ld_styling',
						'settings' => 'subetuweb_ld_item_color',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new subetuwebWP_Customizer_Color_Control(
					...
					'subetuweb_ld_item_hover_color',
					array(
						'label'    => esc_html__( 'Item Hover Color', 'subetuwebwp' ),
						'section'  => 'subetuweb_ld_styling',
						'settings' => 'subetuweb_ld_item_hover_color',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new subetuwebWP_Customizer_Color_Control(
					...
					'subetuweb_ld_complete_color',
					array(
						'label'    => esc_html__( 'Complete Color', 'subetuwebwp' ),
						'section'  => 'subetuweb_ld_styling',
						'settings' => 'subetuweb_ld_complete_color',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new subetuwebWP_Customizer_Color_Control(
					...
					'subetuweb_ld_incomplete_color',
					array(
						'label'    => esc_html__( 'Incomplete Color', 'subetuwebwp' ),
						'section'  => 'subetuweb_ld_styling',
						'settings' => 'subetuweb_ld_incomplete_color',
						'priority' => 10,
					)
				)
			);
			 ...
			 */
			$wp_customize->add_setting(
				'subetuweb_ld_progressbar_color',
				array(
					'transport'         => 'postMessage',
					'sanitize_callback' => 'subetuwebwp_sanitize_color',
				)
			...
			$wp_customize->add_control(
				new subetuwebWP_Customizer_Color_Control(
					...
					array(
						...
						'section'  => 'subetuweb_ld_styling',
						'settings' => 'subetuweb_ld_progressbar_color',
						'priority' => 10,
					)
				)
			);
		...
		public static function head_css( $output ) {
			...
			// Course Table.
			$heading_color     = get_theme_mod( 'subetuweb_ld_heading_color' );
			$heading_bg_color  = get_theme_mod( 'subetuweb_ld_heading_bg_color' );
			$item_color        = get_theme_mod( 'subetuweb_ld_item_color' );
			$item_hover_color  = get_theme_mod( 'subetuweb_ld_item_hover_color' );
			$complete_color    = get_theme_mod( 'subetuweb_ld_complete_color' );
			$incomplete_color  = get_theme_mod( 'subetuweb_ld_incomplete_color' );
			$progressbar_color = get_theme_mod( 'subetuweb_ld_progressbar_color' );

			// Both Sidebars - Global.
			$ld_global_layout         = get_theme_mod( 'subetuweb_ld_global_layout', 'full-width' );
			$bs_global_content_width  = get_theme_mod( 'subetuweb_ld_global_both_sidebars_content_width' );
			$bs_global_sidebars_width = get_theme_mod( 'subetuweb_ld_global_both_sidebars_sidebars_width' );

			// Both Sidebars - Course.
			$ld_course_layout         = get_theme_mod( 'subetuweb_ld_course_layout', 'left-sidebar' );
			$bs_course_content_width  = get_theme_mod( 'subetuweb_ld_course_both_sidebars_content_width' );
			$bs_course_sidebars_width = get_theme_mod( 'subetuweb_ld_course_both_sidebars_sidebars_width' );

			// Both Sidebars - Lesson.
			$ld_lesson_layout         = get_theme_mod( 'subetuweb_ld_lesson_layout', 'left-sidebar' );
			$bs_lesson_content_width  = get_theme_mod( 'subetuweb_ld_lesson_both_sidebars_content_width' );
			$bs_lesson_sidebars_width = get_theme_mod( 'subetuweb_ld_lesson_both_sidebars_sidebars_width' );
...
return new subetuwebWP_LearnDash_Customizer();
