...
if ( ! class_exists( 'subetuwebWP_Typography_Customizer' ) ) :

	class subetuwebWP_Typography_Customizer {
		...
		public function __construct() {
			...
			if ( is_customize_preview() ) {
				...
				add_filter( 'subetuweb_head_css', array( $this, 'head_css' ), 99 );
			}
		...
		public function elements() {
			...
			return apply_filters(
				'subetuweb_typography_settings',
				array(
					'body'                 => array(
						'label'    => esc_html__( 'Body', 'subetuwebwp' ),
						'target'   => 'body',
						'defaults' => array(
							'font-size'   => '14px',
							'color'       => '#929292',
					...
					'headings'             => array(
						'label'    => esc_html__( 'All Headings', 'subetuwebwp' ),
						'target'   => 'h1,h2,h3,h4,h5,h6,.theme-heading,.widget-title,.subetuwebwp-widget-recent-posts-title,.comment-reply-title,.entry-title,.sidebar-box .widget-title',
					...
					'heading_h1'           => array(
						'label'    => esc_html__( 'Heading 1 (H1)', 'subetuwebwp' ),
						'target'   => 'h1',
						'defaults' => array(
							'font-size'   => '23px',
							'color'       => '#333333',
					...
					'heading_h2'           => array(
						'label'    => esc_html__( 'Heading 2 (H2)', 'subetuwebwp' ),
						'target'   => 'h2',
						'defaults' => array(
							'font-size'   => '20px',
							'color'       => '#333333',
					...
					'heading_h3'           => array(
						'label'    => esc_html__( 'Heading 3 (H3)', 'subetuwebwp' ),
						'target'   => 'h3',
						'defaults' => array(
							'font-size'   => '18px',
							'color'       => '#333333',
					...
					'heading_h4'           => array(
						'label'    => esc_html__( 'Heading 4 (H4)', 'subetuwebwp' ),
						'target'   => 'h4',
						'defaults' => array(
							'font-size'   => '17px',
							'color'       => '#333333',
					...
					'logo'                 => array(
						'label'    => esc_html__( 'Logo', 'subetuwebwp' ),
					...
					'menu'                 => array(
						'label'    => esc_html__( 'Main Menu', 'subetuwebwp' ),
					...
					'menu_dropdown'        => array(
						'label'    => esc_html__( 'Main Menu: Dropdowns', 'subetuwebwp' ),
					...
					'page_title'           => array(
						'label'           => esc_html__( 'Page Title', 'subetuwebwp' ),
						...
						'active_callback' => 'subetuwebwp_cac_has_page_header',
					),
					'page_subheading'      => array(
						'label'           => esc_html__( 'Page Title Subheading', 'subetuwebwp' ),
					...
					'blog_entry_title'     => array(
						'label'    => esc_html__( 'Blog Entry Title', 'subetuwebwp' ),
					...
					'blog_post_title'      => array(
						'label'    => esc_html__( 'Blog Post Title', 'subetuwebwp' ),
					...
					'single_post_title'      => array(
						'label'    => esc_html__( 'Blog Post Title Heading', 'subetuwebwp' ),
						'target'   => '.subetuweb-single-post-header .single-post-title',
						'defaults' => array(
							'font-size'      => '34px',
							'color'          => '#333333',
							'line-height'    => '1.4',
					...
					'single_post_meta'      => array(
						'label'    => esc_html__( 'Blog Post Title Meta', 'subetuwebwp' ),
						'target'   => '.subetuweb-single-post-header ul.meta-item li, .subetuweb-single-post-header ul.meta-item li a',
						'defaults' => array(
							'font-size'      => '13px',
							'color'          => '#333333',
							'line-height'    => '1.4',
					...
					'single_post_title_author'      => array(
						'label'    => esc_html__( 'Blog Post Title Author', 'subetuwebwp' ),
						'target'   => '.subetuweb-single-post-header .post-author-name, .subetuweb-single-post-header .post-author-name a',
						'defaults' => array(
							'font-size'      => '14px',
							'color'          => '#333333',
							'line-height'    => '1.4',
					...
					'single_post_title_author_bio'      => array(
						'label'    => esc_html__( 'Blog Post Title Author Bio', 'subetuwebwp' ),
						'target'   => '.subetuweb-single-post-header .post-author-description',
						'defaults' => array(
							'font-size'      => '12px',
							'color'          => '#333333',
							'line-height'    => '1.4',
					...
					'sidebar_widget_title' => array(
						'label'    => esc_html__( 'Sidebar Widget Heading', 'subetuwebwp' ),
					...
					'footer_widget_title'  => array(
						'label'           => esc_html__( 'Footer Widget Heading', 'subetuwebwp' ),
					...
					'copyright'            => array(
						'label'           => esc_html__( 'Footer Copyright', 'subetuwebwp' ),
						...
						'active_callback' => 'subetuwebwp_cac_has_footer_bottom',
					),
					'footer_menu'          => array(
						'label'           => esc_html__( 'Footer Menu', 'subetuwebwp' ),
		...
		public function customizer_options( $wp_customize ) {
			...
			$wp_customize->add_panel(
				'subetuweb_typography_panel',
				array(
					'title'    => esc_html__( 'Typography', 'subetuwebwp' ),
					'priority' => 210,
				)
			);
			...
			$wp_customize->add_section(
				'subetuweb_typography_general',
				array(
					'title'    => esc_html__( 'General', 'subetuwebwp' ),
					'priority' => 1,
					'panel'    => 'subetuweb_typography_panel',
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					'subetuweb_disable_google_font',
					array(
						'label'    => esc_html__( 'Disable Google Fonts', 'subetuwebwp' ),
						'type'     => 'checkbox',
						'section'  => 'subetuweb_typography_general',
						'settings' => 'subetuweb_disable_google_font',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					'subetuweb_local_google_font',
					array(
						'label'    => esc_html__( 'Google Fonts from Site', 'subetuwebwp' ),
						'type'     => 'checkbox',
						'section'  => 'subetuweb_typography_general',
						'settings' => 'subetuweb_local_google_font',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new subetuwebWP_Customize_Multicheck_Control(
					$wp_customize,
					'subetuweb_google_font_subsets',
					array(
						'label'    => esc_html__( 'Font Subsets', 'subetuwebwp' ),
						'section'  => 'subetuweb_typography_general',
						'settings' => 'subetuweb_google_font_subsets',
						'priority' => 10,
						'choices'  => array(
							'latin'        => 'latin',
							'latin-ext'    => 'latin-ext',
			...
			foreach ( $elements as $element => $array ) {
				...
				if ( $label ) {
					...
					if ( in_array( 'font-family', $attributes ) ) {
						...
						$wp_customize->add_control(
							new subetuwebWP_Customizer_Typography_Control(
								$wp_customize,
								$element . '_typography[font-family]',
								array(
									'label'           => esc_html__( 'Font Family', 'subetuwebwp' ),
									'section'         => 'subetuweb_typography_' . $element,
					...
					if ( in_array( 'font-weight', $attributes ) ) {
						...
						$wp_customize->add_control(
							$element . '_typography[font-weight]',
							array(
								'label'           => esc_html__( 'Font Weight', 'subetuwebwp' ),
								'description'     => esc_html__( 'Important: Not all fonts support every font-weight.', 'subetuwebwp' ),
								'section'         => 'subetuweb_typography_' . $element,
								...
								'choices'         => array(
									...
									'100' => esc_html__( 'Thin: 100', 'subetuwebwp' ),
									'200' => esc_html__( 'Light: 200', 'subetuwebwp' ),
									'300' => esc_html__( 'Book: 300', 'subetuwebwp' ),
									'400' => esc_html__( 'Normal: 400', 'subetuwebwp' ),
									'500' => esc_html__( 'Medium: 500', 'subetuwebwp' ),
									'600' => esc_html__( 'Semibold: 600', 'subetuwebwp' ),
									'700' => esc_html__( 'Bold: 700', 'subetuwebwp' ),
									'800' => esc_html__( 'Extra Bold: 800', 'subetuwebwp' ),
									'900' => esc_html__( 'Black: 900', 'subetuwebwp' ),
								),
							)
						);
					}
					...
					if ( in_array( 'font-style', $attributes ) ) {
						...
						$wp_customize->add_control(
							$element . '_typography[font-style]',
							array(
								'label'           => esc_html__( 'Font Style', 'subetuwebwp' ),
								'section'         => 'subetuweb_typography_' . $element,
								...
								'choices'         => array(
									...
									'italic' => esc_html__( 'Italic', 'subetuwebwp' ),
								),
							)
						);
					...
					if ( in_array( 'text-transform', $attributes ) ) {
						...
						$wp_customize->add_control(
							$element . '_typography[text-transform]',
							array(
								'label'           => esc_html__( 'Text Transform', 'subetuwebwp' ),
								'section'         => 'subetuweb_typography_' . $element,
								...
								'choices'         => array(
									''           => esc_html__( 'Default', 'subetuwebwp' ),
									'capitalize' => esc_html__( 'Capitalize', 'subetuwebwp' ),
									'lowercase'  => esc_html__( 'Lowercase', 'subetuwebwp' ),
									'uppercase'  => esc_html__( 'Uppercase', 'subetuwebwp' ),
					...
					if ( in_array( 'font-size', $attributes ) ) {
						...
						$wp_customize->add_control(
							new subetuwebWP_Customizer_Text_Control(
								$wp_customize,
								$element . '_typography[font-size]',
								array(
									'label'           => esc_html__( 'Font Size', 'subetuwebwp' ),
									'description'     => esc_html__( 'You can add: px-em-%', 'subetuwebwp' ),
									'section'         => 'subetuweb_typography_' . $element,
									'settings'        => array(
					...
					if ( in_array( 'line-height', $attributes ) ) {
						...
						$wp_customize->add_control(
							new subetuwebWP_Customizer_Slider_Control(
								...
								$element . '_typography[line-height]',
								array(
									'label'           => esc_html__( 'Line Height', 'subetuwebwp' ),
									'section'         => 'subetuweb_typography_' . $element,
									'settings'        => array(
					...
					if ( in_array( 'letter-spacing', $attributes ) ) {
						...
						$wp_customize->add_control(
							new subetuwebWP_Customizer_Slider_Control(
								...
								$element . '_typography[letter-spacing]',
								array(
									'label'           => esc_html__( 'Letter Spacing (px)', 'subetuwebwp' ),
									'section'         => 'subetuweb_typography_' . $element,
									'settings'        => array(
					...
					if ( in_array( 'font-color', $attributes ) ) {
						...
						$wp_customize->add_control(
							new subetuwebWP_Customizer_Color_Control(
								...
								$element . '_typography[color]',
								array(
									'label'           => esc_html__( 'Font Color', 'subetuwebwp' ),
									'section'         => 'subetuweb_typography_' . $element,
		...
		public function customize_preview_init() {
			wp_enqueue_script( 'subetuwebwp-typography-customize-preview', subetuwebWP_INC_DIR_URI . 'customizer/assets/js/typography-customize-preview.min.js', array( 'customize-preview' ), subetuwebWP_THEME_VERSION, true );
			wp_localize_script(
				'subetuwebwp-typography-customize-preview',
				'subetuwebwpTG',
				array(
			...
			if ( subetuwebWP_WOOCOMMERCE_ACTIVE ) {
				wp_enqueue_script( 'subetuwebwp-woo-typography-customize-preview', subetuwebWP_INC_DIR_URI . 'customizer/assets/js/woo-typography-customize-preview.min.js', array( 'customize-preview' ), subetuwebWP_THEME_VERSION, true );
				wp_localize_script(
					'subetuwebwp-woo-typography-customize-preview',
					'subetuwebwpTG',
					array(
						'googleFontsUrl'    => '//fonts.googleapis.com',
						'googleFontsWeight' => '100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i',
		...
		public function load_fonts() {
			...
			if ( ! empty( $fonts ) && is_array( $fonts ) ) {
				foreach ( $fonts as $font ) {
					subetuwebwp_enqueue_google_font( $font );
				}
			}
...
return new subetuwebWP_Typography_Customizer();
