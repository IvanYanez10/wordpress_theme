    ...
    wp.customize.bind('ready', function() {
        ...
        api.section.each( function( section ) {
            section.container.bind( 'expanded', function() {
                ...
                if ( added ) {
                    jQuery( document ).trigger('subetuwebready');
                }
            } )
        } )
        ...
        wp.customize.previewer.bind('url',function(to) {
            localStorage.setItem( 'subetuwebCustomizePreviewUrl', to );
        })

        if ( localStorage.getItem( 'subetuwebCustomizePreviewUrl' ) ) {
            wp.customize.previewer.previewUrl( localStorage.getItem( 'subetuwebCustomizePreviewUrl' ) );
            localStorage.removeItem( 'subetuwebCustomizePreviewUrl' );
        }
    })
