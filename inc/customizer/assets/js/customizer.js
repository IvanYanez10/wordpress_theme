jQuery(document).on('subetuwebready', function() {
	var $ = jQuery;
	"use strict";
	...
	$('.sortable_repeater_control:not(.subetuweb-proccessed)').each(function() {
		$(this).addClass('subetuweb-proccessed');
	...
	$(this).find('.sortable_repeater.sortable:not(.subetuweb-proccessed)').sortable({
		update: function(event, ui) {
			skyrocketGetAllInputs($(this).parent());
		}
	});

	$(this).find('.sortable_repeater.sortable:not(.subetuweb-proccessed)').addClass('subetuweb-proccessed');


	// Remove item starting from it's parent element
	$('.sortable_repeater.sortable:not(.subetuweb-proccessed)').on('click', '.customize-control-sortable-repeater-delete', function(event) {
		$(this).addClass('subetuweb-proccessed');
	...
	// Add new item
	$('.customize-control-sortable-repeater-add:not(.subetuweb-proccessed)').click(function(event) {
		$(this).addClass('subetuweb-proccessed');
		event.preventDefault();
	...
	$('.sortable_repeater.sortable:not(.subetuweb-proccessed)').change(function() {
		$(this).addClass('subetuweb-proccessed');
		skyrocketGetAllInputs($(this).parent());
	})

	// Add https:// to the start of the URL if it doesn't have it
	$('.sortable_repeater.sortable:not(.subetuweb-proccessed)').on('blur', '.repeater-input', function() {
		$(this).addClass('subetuweb-proccessed');
		var url = $(this);
		var val = url.val();
		if (val && !val.match(/^.+:\/\/.*/)) {
	...
	$('.slider-custom-control:not(.subetuweb-proccessed)').each(function() {
		$(this).addClass('subetuweb-proccessed');
	...
	$('.slider:not(.subetuweb-proccessed)').on('slide', function(event, ui) {
		$(this).addClass('subetuweb-proccessed');
		$(this).parent().find('.customize-control-slider-value').val(ui.value);
	});

	// Reset slider and input field back to the default value
	$('.slider-reset:not(.subetuweb-proccessed)').on('click', function() {
		$(this).addClass('subetuweb-proccessed');
	...
	$('.single-accordion-toggle:not(.subetuweb-proccessed)').click(function() {
		$(this).addClass('subetuweb-proccessed');
	...
	$('.multi-image-checkbox:not(.subetuweb-proccessed)').on('change', function() {
		$(this).addClass('subetuweb-proccessed');
	...
	$(".pill_checkbox_control .sortable:not(.subetuweb-proccessed)").sortable({
		placeholder: "pill-ui-state-highlight",
		update: function(event, ui) {
			skyrocketGetAllPillCheckboxes($(this).parent());
		}
	});
	$(".pill_checkbox_control .sortable:not(.subetuweb-proccessed)").addClass('subetuweb-proccessed');

	$('.pill_checkbox_control .sortable-pill-checkbox:not(.subetuweb-proccessed)').on('change', function() {
		$(this).addClass('subetuweb-proccessed');
	...
	$('.customize-control-dropdown-select2:not(.subetuweb-proccessed)').each(function() {
		$(this).addClass('subetuweb-proccessed');
	...
	$(".customize-control-select2:not(.subetuweb-proccessed)").on("change", function() {
		$(this).addClass('subetuweb-proccessed');
	...
	$('.google-fonts-list:not(.subetuweb-proccessed)').each(function(i, obj) {
		$(this).addClass('subetuweb-proccessed');
	...
	$('.google-fonts-list:not(.subetuweb-proccessed)').on('change', function() {
		$(this).addClass('subetuweb-proccessed');
	...
	$('.google_fonts_select_control select:not(.subetuweb-proccessed)').on('change', function() {
		$(this).addClass('subetuweb-proccessed');
		skyrocketGetAllSelects($(this).parent().parent());
	});
	...
	$('.customize-control-tinymce-editor:not(.subetuweb-proccessed)').each(function() {
		$(this).addClass('subetuweb-proccessed');
	...
	$('.wpcolorpicker-alpha-color-picker:not(.subetuweb-proccessed)').each(function(i, obj) {
		$(this).addClass('subetuweb-proccessed');
	...
	$('.alpha-color-control:not(.subetuweb-proccessed)').each(function() {
		...
		colorPickerOptions = {
			...
			palettes: subetuwebwpLocalize.colorPalettes // Use the passed in palette.
		};
