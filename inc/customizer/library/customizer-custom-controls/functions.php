...
if ( ! function_exists( 'skyrocket_scripts_styles' ) ) {
	function skyrocket_scripts_styles() {
		...
		wp_register_style( 'fontawesome', subetuwebWP_INC_DIR_URI . 'customizer/assets/css/fontawesome-all.min.css', array(), '5.8.2', 'all' );
...
if ( ! function_exists( 'skyrocket_customizer_preview_scripts' ) ) {
	function skyrocket_customizer_preview_scripts() {
		wp_enqueue_script( 'skyrocket-customizer-preview', subetuwebWP_INC_DIR_URI . 'customizer/assets/js/customizer-preview.js', array( 'customize-preview', 'jquery' ) );
	}
}
