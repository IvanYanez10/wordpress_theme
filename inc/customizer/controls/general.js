jQuery(document).on('subetuwebready', function() {
	...
	$( '.customize-control .responsive-switchers button:not(.subetuweb-proccessed)' ).on( 'click', function( event ) {
	...
	$( '.wp-full-overlay-footer .devices button:not(.subetuweb-proccessed)' ).on( 'click', function( event ) {
