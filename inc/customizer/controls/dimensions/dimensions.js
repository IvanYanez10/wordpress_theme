var $ = jQuery;
wp.customize.controlConstructor['subetuwebwp-dimensions'] = wp.customize.Control.extend({
...
$( document ).on( 'click', '.subetuwebwp-linked',  function() {
...
// Unlinked button
$( document ).on( 'click', '.subetuwebwp-unlinked',  function() {
