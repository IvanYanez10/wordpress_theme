...
$classes      = '';
$topbar_style = get_theme_mod( 'subetuweb_top_bar_style', 'one' );
if ( 'one' === $topbar_style ) {
...
// Get ID.
$get_id = get_theme_mod( 'subetuweb_top_bar_social_alt_template' );

// Check if page is Elementor page.
$elementor = get_post_meta( $get_id, '_elementor_edit_mode', true );

// Get content.
$get_content = subetuwebwp_top_bar_social_alt_content();
...
if ( $get_id ) : ?>
	...
	<div id="top-bar-social-alt" class="clr <?php echo esc_attr( $classes ); ?>">
		...
		if ( subetuwebWP_ELEMENTOR_ACTIVE && $elementor ) {
			...
			subetuwebWP_Elementor::get_topbar_social_alt_content();
...
if ( ! $profiles = get_theme_mod( 'subetuweb_top_bar_social_profiles' ) ) {
	return;
}

// Get theme mods.
$link_target = get_theme_mod( 'subetuweb_top_bar_social_target', 'blank' );
...
<div id="top-bar-social" class="clr <?php echo esc_attr( $classes ); ?>">
	...
	<ul class="clr" aria-label="<?php echo esc_attr__( 'Social links', 'subetuwebwp' ); ?>">
