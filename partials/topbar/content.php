...
// Get the template.
$template = get_theme_mod( 'subetuweb_top_bar_template' );

// Check if page is Elementor page.
$elementor = get_post_meta( $template, '_elementor_edit_mode', true );

// Get content.
$get_content = subetuwebwp_topbar_template_content();

// Get topbar content.
$content = get_theme_mod( 'subetuweb_top_bar_content' );
$content = subetuwebwp_tm_translation( 'subetuweb_top_bar_content', $content );
...
if ( ! empty( $template )
	...
	<div id="top-bar-content" class="<?php echo esc_attr( subetuwebwp_topbar_content_classes() ); ?>">
		...
		if ( ! empty( $template ) ) {
			...
			<div id="topbar-template">
				...
				if ( subetuwebWP_ELEMENTOR_ACTIVE && $elementor ) {
					...
					subetuwebWP_Elementor::get_topbar_content();
