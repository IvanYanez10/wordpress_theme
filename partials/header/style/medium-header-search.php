...
<div id="medium-searchform" class="header-searchform-wrap clr">
	<form method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" class="header-searchform" role="search" aria-label="<?php esc_attr_e( 'Medium Header Search', 'subetuwebwp' ); ?>">
		...
		if ( subetuweb_EXTRA_ACTIVE
			...
			?>
			<label><?php subetuwebwp_theme_strings( 'owp-string-medium-header-search-text', 'subetuwebwp' ); ?></label>
			<?php
		}
		?>
