...
// Menu position.
$position = get_theme_mod( 'subetuweb_top_header_menu_position', 'before' );
...
// Search style.
$search = subetuwebwp_menu_search_style(); ?>
...
<div class="<?php echo esc_attr( subetuwebwp_top_header_classes() ); ?>">
