...
$be_seo_set = get_theme_mod( 'subetuweb_enable_be_fimage_alt', false );
...
$be_fimage_alt = ( false === $be_seo_set || ( true === $be_seo_set && ! $fe_img_alt ) ) ? subetuwebwp_theme_strings( 'owp-string-read-more-article', false ) . ' ' . get_the_title() : $fe_img_alt;
