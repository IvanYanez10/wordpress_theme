...
// Image position.
$position        = get_theme_mod( 'subetuweb_blog_thumbnail_image_position', 'left' );
$position        = $position ? $position : 'left';
$inner_classes[] = $position . '-position';

// Vertical postion.
$ver_position    = get_theme_mod( 'subetuweb_blog_thumbnail_vertical_position', 'center' );
