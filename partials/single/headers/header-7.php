...
// Heading tag.
$heading = 'h1';
$heading = apply_filters( 'single_subetuweb_header_7_h_tag', $heading );

// Display meta filter.
$display_sph_meta = true;
$display_sph_meta = apply_filters( 'display_single_subetuweb_header_7_meta', $display_sph_meta );
...
<div class="subetuweb-single-post-header single-header-subetuweb-7 <?php echo esc_attr( $class ); ?>">
    ...
    <?php subetuwebwp_paint_post_thumbnail( 'full', array( 'name' => 'subetuweb-sh-7' ) ); ?>
</div>
